...
WMEFunction.prototype.getCheckboxId = function() {
    //    console.log("Askingfor checkbox id which is " + this.checkboxId);
...
//            console.log('Adding user.userName = ' + user.userName);
...
function createWazeMapEventAction(actionName) {
    return function() {
        setTimeout(function() {
            console.log("--->> wazeMap." + actionName + " <<---");
            highlightSegments();
        }, 100);
        return true;
    };
...
function createEventAction(eventHolderName, actionName) {
    return function() {
//        console.log("--->>> " + eventHolderName + "." + actionName + " <<<---");
        highlightSegments();
        populateUserList();
        populateCityList();
        return true;
